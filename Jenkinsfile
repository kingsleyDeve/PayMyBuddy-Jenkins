pipeline {
    ...
    steps {
        sh """
            ...
            docker run -d --net paymybuddy-net --name mysql -e MYSQL_DATABASE=db_paymybuddy -e MYSQL_USER=tes -e MYSQL_PASSWORD=pass -e MYSQL_ROOT_PASSWORD=pass  -v paymybuddy-data:/var/lib/mysql -v ./var/jenkins_home/workspace/test/src/main/resources/database/create.sql:/docker-entrypoint-initdb.d/create.sql:ro -p 3306:3306 mysql
